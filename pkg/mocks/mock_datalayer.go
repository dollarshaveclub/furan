...
func (m *MockDataLayer) CreateBuild(arg0 context.Context, arg1 *furanrpc.BuildRequest) (gocql.UUID, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataLayer) GetBuildByID(arg0 context.Context, arg1 gocql.UUID) (*furanrpc.BuildStatusResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBuildByID", arg0, arg1)
	ret0, _ := ret[0].(*furanrpc.BuildStatusResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDataLayer) GetBuildOutput(arg0 context.Context, arg1 gocql.UUID, arg2 string) ([]furanrpc.BuildEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBuildOutput", arg0, arg1, arg2)
	ret0, _ := ret[0].([]furanrpc.BuildEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDataLayer) SaveBuildOutput(arg0 context.Context, arg1 gocql.UUID, arg2 []furanrpc.BuildEvent, arg3 string) error {
	m.ctrl.T.Helper()
...
func (m *MockDataLayer) SetBuildState(arg0 context.Context, arg1 gocql.UUID, arg2 furanrpc.BuildStatusResponse_BuildState) error {
	m.ctrl.T.Helper()
