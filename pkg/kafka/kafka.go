...
func (kp *KafkaManager) PublishEvent(event *furanrpc.BuildEvent) error {
...
func (kp *KafkaManager) SubscribeToTopic(output chan<- *furanrpc.BuildEvent, done <-chan struct{}, buildID gocql.UUID) error {
